...
export default {
  setup () {
    return {
      ...
      localState:reactive({
        cars:[
          {id:1,src:'https://img.freepik.com/free-photo/blue-sport-sedan-parked-yard_114579-5078.jpg',title:'Bolero SUV 300',description:"lorme",km_rate:'15 Per Km',duty_rate:900},
          {id:1,src:'https://img.freepik.com/free-photo/blue-sport-sedan-parked-yard_114579-5078.jpg',title:'Bolero SUV 300',description:"lorme",km_rate:'15 Per Km',duty_rate:900},
        ]
      })
    }
